<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($entered_otp == $_SESSION['otp']) {
            $insert_data = "INSERT INTO `users` (`name`, `email`, `phone`, `type`, `pass`, `dt`) VALUES ('$name', '$email', '$phone', '$type', '$encpass', current_timestamp());";
            ...
            if (!$data_check) {
                ...
                $subject="Greetings From RELEC";
                $message=" <h4>Welcome, $name <br><br></h4>
                <h4>You have succesfully Registered yourself to RELEC.<br><br></h4>
                <h4 style='color: blue;'>
...
<body>
    ...
    <section class="ctn">
        <div class="container container__contact">
            ...
            <form class="contact__form" action="./user-otp.php" method="post" data-aos="fade-left">
                <h2 class="text-center">OTP Page</h2>
                <?php
            ...
            ?>
                ...
                <div style="margin: auto; margin-top: 2rem;">
                    <button type="submit" class="cbtn" name="submit">Signup</button>
                </div>
            </form>
        </div>
    </section>
