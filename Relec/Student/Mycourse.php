    ...
    <section class="courses">
        ...
        <div class="container container__courses">
            <?php
                ...
                $sql = "SELECT * FROM `buylist` WHERE `email` = '$email'";
                $res = $conn->query($sql);
                if($res->num_rows>0)
                {
            ...
            <?php
                    ...
                    $errors['noitem'] = "You haven't Purchased any courses";
                }
            ?>
        </div>
        <div class="container">
    ...
    <footer class="container-fluid text-center text-white">
        ...
        <div class="footer1 row">
            ...
            <div class="col-md-10 Social">
                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-2" target="blank" href="https://www.instagram.com/"
                    role="button"><i class="uil uil-instagram"></i></a>

                <!-- Twitter -->
                <a class="btn btn-outline-light btn-floating m-2" target="blank" href="https://twitter.com/"
                    role="button"><i class="uil uil-twitter-alt"></i></a>

                <!-- Linkdnin -->
                <a class="btn btn-outline-light btn-floating m-2" target="blank" href="https://in.linkedin.com/"
                    role="button"><i class="uil uil-linkedin-alt"></i></a>

                <!-- Facebook -->
                <a class="btn btn-outline-light btn-floating m-2" target="blank" href="https://m.facebook.com/"
                    role="button"><i class="uil uil-facebook-f"></i></a>
