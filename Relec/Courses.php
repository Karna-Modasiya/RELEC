        ...
        <div class="container container__courses">
            <?php
                ...
                if($res->num_rows>0)
                {
                    ...
                    {
                        ?>
            <article class="cs" data-aos="fade-right" data-aos="fade-right">
                <div class="course__image">
                    <img src="data:image/jpg;charset=utf8;base64,<?=base64_encode($row['img'])?>" alt="">
                </div>
                <div class="courses__info">
                    <h4><?=$row['name']?></h4>
                    <h6><b>Author : </b><?=$row['author']?></h6>
                    <div class="mx-2"><b>Rating : </b><?=$row['rating']?></div>
                    <div class="mx-2 mt-2"><b>Price : </b><?=$row['price']?></div>
                    <div class="desc mb-2"><?=$row['desc']?></div>
                    <div class="cart">
                        <a href="./login-user.php" class="cbtn">More Details</a>
                        <!-- <div class="cbtn">Add to Wishlist<i class="uil uil-heart mx-2"></i></div> -->
                        <!-- <div class="cbtn">Add to cart<i class="uil uil-shopping-cart-alt"></i></div> -->
                    </div>
                </div>
            </article>
            <?php
